...
from app.documents.loader import _load_txt, _load_pdf, SUPPORTED_EXTENSIONS
from app.documents.chunker import chunk_document_by_strategy
            ...
            try:
                ...
                with open(chunks_file, "r", encoding="utf-8") as f:
                    ...
                    for c in old_chunks:
                        app = c.get("source")
                        if app:
                            previous_chunks_map.setdefault(app, []).append(c)
