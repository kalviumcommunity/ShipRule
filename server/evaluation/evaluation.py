...
UNIVERSAL_SEMANTIC_EVALUATION_DATASET: List[Dict[str, Any]] = [
    # Terminology & Paraphrase Variations for Electronics / Tech Products
    {
        "query": "What legal compliance certifications apply to electrical gadgets and tech items?",
        "expected_source": "customs_requirements.txt",
        "topic": "Terminology Variation — Tech / Electrical Gadgets"
    },
    {
        "query": "What regulations govern technology products and consumer electronics imports?",
        "expected_source": "customs_requirements.txt",
        "topic": "Terminology Variation — Technology Products"
    },
    {
        "query": "Which approvals are necessary for digital hardware and electronic equipment?",
        "expected_source": "customs_requirements.txt",
        "topic": "Terminology Variation — Digital Hardware"
    },
    # Country & Region Variations
    {
        "query": "What are the import procedures for shipping goods to America?",
        "expected_source": "shipping_rules.txt",
        "topic": "Country Variation — America / US"
    },
    {
        "query": "What mandatory compliance guidelines exist for importing items into the USA?",
        "expected_source": "shipping_rules.txt",
        "topic": "Country Variation — USA"
    },
    # Question & Sentence Structure Variations
    {
        "query": "Which papers must I present when clearing freight through international borders?",
        "expected_source": "shipping_rules.txt",
        "topic": "Sentence Variation — Clearance Papers"
    },
    {
        "query": "What do I need to comply with when transporting commercial cargo?",
        "expected_source": "shipping_rules.txt",
        "topic": "Sentence Variation — Cargo Transport Rules"
    },
    {
        "query": "Which goods and commodities are permitted for overseas shipment?",
        "expected_source": "shipping_rules.txt",
        "topic": "Sentence Variation — Permitted Shipment"
    }
]
